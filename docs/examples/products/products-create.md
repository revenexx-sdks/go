...
response, error := service.ProductsCreate(
    ...
    products.WithProductsCreateDeletedAt("2026-01-01T12:00:00Z"),
    products.WithProductsCreateEnabled(true),
    products.WithProductsCreateFamilyId(""),
    products.WithProductsCreateFamilyVariantId(""),
    products.WithProductsCreateKind("simple"),
    ...
    products.WithProductsCreateTaxClass("standard"),
)
```
