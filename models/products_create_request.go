...
func (model ProductsCreateRequest) New(data []byte) *ProductsCreateRequest {
    model.data = data
    return &model
}

func (model *ProductsCreateRequest) Decode(value interface{}) error {
    if len(model.data) <= 0 {
